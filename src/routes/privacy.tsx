    ...
    <div className="min-h-screen bg-[#F8F6F3] font-sans text-[#0F172A]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="bg-white rounded-xl p-8 md:p-12 shadow-sm prose prose-slate max-w-none">
          ...
          <p className="text-slate-600 leading-relaxed mb-2"><strong>All Users:</strong></p>
          <ul className="list-disc pl-6 text-slate-600 mb-3">
          ...
          <p className="text-slate-600 leading-relaxed mb-2"><strong>Businesses:</strong></p>
          <ul className="list-disc pl-6 text-slate-600 mb-3">
          ...
          <p className="text-slate-600 leading-relaxed mb-2"><strong>Workers:</strong></p>
          <ul className="list-disc pl-6 text-slate-600 mb-3">
      ...
      <footer className="border-t border-slate-200 px-6 py-8">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-xs text-slate-400">
            <a href="/privacy" className="hover:text-[#0F172A] transition font-semibold text-slate-600">Privacy</a>
