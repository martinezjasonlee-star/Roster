        ...
        <div className="bg-white rounded-xl p-8 md:p-12 shadow-sm prose prose-slate max-w-none">
          ...
          <div className="overflow-x-auto mb-4">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-b"><td className="py-2 pr-4 text-slate-600"><strong>Platform</strong></td><td className="py-2 text-slate-600">Roster's website and related services at https://roster-work.com</td></tr>
                <tr className="border-b"><td className="py-2 pr-4 text-slate-600"><strong>Business</strong></td><td className="py-2 text-slate-600">A venue or operator using the Platform to find and book Workers</td></tr>
                <tr className="border-b"><td className="py-2 pr-4 text-slate-600"><strong>Worker</strong></td><td className="py-2 text-slate-600">A hospitality professional using the Platform to find shift work</td></tr>
                <tr className="border-b"><td className="py-2 pr-4 text-slate-600"><strong>Shift</strong></td><td className="py-2 text-slate-600">A work assignment posted by a Business and accepted by a Worker</td></tr>
                <tr className="border-b"><td className="py-2 pr-4 text-slate-600"><strong>Membership</strong></td><td className="py-2 text-slate-600">A paid subscription plan for Businesses</td></tr>
              </tbody>
            </table>
          </div>
      ...
      <footer className="border-t border-slate-200 px-6 py-8">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-xs text-slate-400">
            ...
            <a href="/terms" className="hover:text-[#0F172A] transition font-semibold text-slate-600">Terms</a>
